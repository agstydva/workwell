        ...
        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-20 flex space-x-2">
          {heroImages.map((_, idx) => (
            <button
              ...
              className={`h-2.5 rounded-full transition-all duration-300 cursor-pointer ${currentHeroIndex === idx
      ...
      <section className="py-24 bg-slate-50 dark:bg-slate-900/30 border-t border-brand-secondary/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-12 space-y-4 scroll-reveal reveal-up">
            ...
            <p className="text-brand-secondary dark:text-slate-400 text-sm font-medium">Umpan balik dari mahasiswa dan praktisi profesional yang telah mentransformasi kebiasaan harian mereka secara berkala.</p>
          </div>
