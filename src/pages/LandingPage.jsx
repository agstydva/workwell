...
const LandingPage = () => {
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      setError('Gagal masuk dengan Google. Pastikan koneksi internet Anda aktif dan coba lagi.');
