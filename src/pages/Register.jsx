...
import { Activity, Mail, Lock, User, AlertCircle, ArrowLeft, CheckCircle2 } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-100 flex flex-col justify-center items-center relative p-4 select-none transition-colors duration-200">
      ...
      <div className="w-full max-w-md glass-panel p-8 rounded-[32px] border border-slate-250 dark:border-slate-800 shadow-2xl relative z-10 space-y-6">
        ...
        {registerSuccess ? (
          <div className="flex flex-col items-center text-center space-y-4 py-6 animate-in fade-in zoom-in-95 duration-200">
            <div className="w-16 h-16 rounded-full bg-emerald-500/10 text-emerald-600 flex items-center justify-center mx-auto">
              <CheckCircle2 className="h-10 w-10 text-emerald-600 animate-bounce" />
            </div>
            <div className="space-y-2">
              <h3 className="text-xl font-black text-slate-800 dark:text-white">Pendaftaran Berhasil!</h3>
            ...
            <Link
              to="/login"
              className="py-3 px-6 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white font-bold rounded-2xl text-xs transition-all shadow-md cursor-pointer flex items-center justify-center mt-2"
            >
              Masuk Sekarang
            </Link>
          </div>
